...
exports.seeds = exports.PersonSchema = void 0;
const mongoose_1 = require("mongoose");
const bcryptjs_1 = __importDefault(require("bcryptjs"));
const database_1 = require("../database");
const person_1 = require("common/types/person");
exports.PersonSchema = new mongoose_1.Schema(person_1.PersonFields, database_1.defaultSchemaOptions);
exports.seeds = [
    {
        person: {
            firstname: "Darío",
            ...
            gender: person_1.PersonGenders.MALE,
        },
        taxId: "20337466711",
        currency: "ARS",
        user: {
    ...
    },
    {
        person: {
            ...
            gender: person_1.PersonGenders.FEMALE,
        },
        taxId: "27373543212",
        currency: 'USD',
        user: {
