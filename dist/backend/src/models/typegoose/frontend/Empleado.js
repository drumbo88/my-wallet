...
exports.EmpleadoFrontend = void 0;
const Empleado_1 = require("../common/Empleado");
// Frontend class
class EmpleadoFrontend extends Empleado_1.Empleado {
    ...
    static getByNombre(nombre) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield fetch(`api/empleado/${nombre}`)
                .then(res => res.json());
        });
    }
}
exports.EmpleadoFrontend = EmpleadoFrontend;
