...
exports.PaymentCardPrepaid = void 0;
const typeorm_1 = require("typeorm");
const PaymentCard_1 = require("./PaymentCard");
const database_1 = require("../database");
class PaymentCardPrepaid {
    constructor(data = {}) {
    }
    static init(data) {
    ...
    save() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield repoPaymentCard.save(Object.assign(Object.assign({}, this.paymentCard), { cardPrepaid: this }));
        });
    }
    static getOne(data) {
        return __awaiter(this, void 0, void 0, function* () {
...
], PaymentCardPrepaid.prototype, "paymentCard", void 0);
exports.PaymentCardPrepaid = PaymentCardPrepaid;
