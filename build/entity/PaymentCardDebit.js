...
exports.PaymentCardDebit = void 0;
const typeorm_1 = require("typeorm");
const PaymentCard_1 = require("./PaymentCard");
const database_1 = require("../database");
class PaymentCardDebit {
    constructor(data = {}) {
    }
    static init(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            obj.paymentCard = yield PaymentCard_1.PaymentCard.init({
                ...
                cardDebit: obj, cardCredit, cardPrepaid
            });
            return obj;
        });
    }
    save() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield repoPaymentCard.save(Object.assign(Object.assign({}, this.paymentCard), { cardDebit: this }));
        });
    }
    static getOne(data) {
        return __awaiter(this, void 0, void 0, function* () {
...
], PaymentCardDebit.prototype, "paymentCard", void 0);
exports.PaymentCardDebit = PaymentCardDebit;
